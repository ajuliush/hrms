...
<body id="example">
    <div>
        ...
        <br> <br><br>
            ...
            Daughter of: {{ $appointment->emoloyeedetail->father_name ?? null}} &
            ...
            {{ $appointment->emoloyeedetail->postal_area_en ?? null}} - {{ $appointment->emoloyeedetail->postal_code ?? null}}, PS:
            ...
            @else
                {{ 'Ms.' }}
            @endif {{ $appointment->first_name . ' ' . $appointment->last_name ?? null}} <br> <br>
