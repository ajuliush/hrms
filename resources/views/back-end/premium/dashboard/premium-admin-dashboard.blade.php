...
<section class="main-contant-section">
    ...
    <div class="text-center mt-5">
        ...
        <div class="div">
            <p>{{$users_value->userdepartment->department_name}}, {{$users_value->userdesignation->designation_name}}
            </p>
        </div>
        @endforeach
        ...
        <div class="div">
            ...
            <form class="d-inline m1-2" method="post" action="{{route('employee-attendance')}}">
                ...
                <button type="submit" class="btn btn-success"><i class="fa fa-star-circle"></i> {{__('Check Out')}}
                </button>
                @else
                <input type="hidden" name="check_in_request" value="check_in_request">
                <button type="submit" class="btn btn-success"><i class="fa fa-star-circle"></i> {{__('Check In')}}
                </button>
                @endif
    ...
    <script type="text/javascript">
        ...
        var options = {
            ...
            is3D: true,
            colors: ['#ff7588', '#009933', '#0059b3', '#00ffaa', '#00cccc','#008ae6', '#000080', '#2dd5eb', '#669999',
    ...
    <script type="text/javascript">
        ...
        var options = {
            ...
            is3D: true,
            colors: ['#ff7588', '#009933', '#0059b3', '#00ffaa', '#00cccc','#008ae6', '#000080', '#2dd5eb', '#669999', '#8c1aff','#D6816F','#719945','#459990']
        };
    ...
    <script type="text/javascript">
        ...
        function drawChart() {
        var data = google.visualization.arrayToDataTable([
            ['Project','Progress', 'Employee', { role: 'annotation' } ],
            [' ', 00, 00, ''],
        ...
        var options = {
            ...
            bar: { groupWidth: '75%' },
            isStacked: true,
            colors: ['#009933', '#459990', '#0059b3', '#00ffaa', '#00cccc','#008ae6', '#000080', '#2dd5eb', '#669999', '#8c1aff','#D6816F','#719945','#ff7588']
        };
