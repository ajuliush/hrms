                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="text" name="present_village"
                                                                    class="form-control" value=""
                                                                    placeholder="Village Name" value="" required />
                                                            </div>
                                                        </div>
                                                ...
                                                <div class="col-md-4 expiry_date">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <input type="date" name="in_trine_month_contractual" class="form-control" value="{{ $employee_basic_infos_value->in_trine_month }}">
                                                        </div>
                                                    </div>
                                                </div>
                                                @endif
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <label class="text-bold">{{ __('Probation Month') }}
                                                            ...
                                                            <select name="in_probation_month" id="" class="form-control" required>
                                                                ...
                                                                <option {{ $employee_basic_infos_value->in_probation_month == 3 ? 'selected' : '' }} value="3">Three Month</option>
                                                                <option {{ $employee_basic_infos_value->in_probation_month == 6 ? 'selected' : '' }} value="6">Six Month</option>
                                                            </select>
                                                    </div>
                                                </div>
                                                @endif
                                    ...
                                    <form method="POST" action="{{ route('update-certificate-letter') }}"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-4">
                                                <div class="form-group">
                                                    <label for="website">
                                                        Salary Increment Letter<span class="text-danger">*</span></label>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend"></div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label for="" class="text-bold">Union Name:<span
                                                            class="text-danger">*</span></label>
