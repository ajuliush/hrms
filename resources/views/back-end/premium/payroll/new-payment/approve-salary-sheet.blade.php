...
<body>
    <section class="main-contant-section">
        ...
        <div>
         <div style="">  <br/> <br/>  ______________ <br/> Prepared By<br/></div>
          <div style="margin-top:-4%; margin-left: 45%;">  ______________<br/>checked By<br/> </div>
          <div style="margin-top:-4%; margin-left: 80%;">  ______________<br/>Approved By<br/></div>
        </div>
