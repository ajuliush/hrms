        ...
        try {
            $package_content_array = [
                [
                    ...
                    $request->core_hr_sub_module_fifteen,
                    $request->core_hr_sub_module_fifteen_add,
                    $request->core_hr_sub_module_fifteen_edit,
                    $request->core_hr_sub_module_fifteen_delete,
                    ...
                    $request->finger_print_module,
                    $request->finger_print_sub_module_one,
        ...
        try {
            $content_array = [
                [
                    ...
                    $request->finger_print_module,
                    $request->finger_print_sub_module_one,
                    $request->finger_print_sub_module_one_add,
                    $request->finger_print_sub_module_one_edit,
                    $request->finger_print_sub_module_one_delete
